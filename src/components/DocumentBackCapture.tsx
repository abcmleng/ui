      ...
      <div className="flex-1 flex items-center justify-center p-4 min-h-0">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            {/* Title Section */}
            <div className="bg-gradient-to-r from-orange-600 to-red-600 px-6 py-6 text-center">
              <CreditCard className="w-10 h-10 mx-auto mb-3 text-white" />
              <h1 className="text-xl font-bold text-white mb-2">Document Back</h1>
              ...
              <div className="space-y-3">
                {!capturedImage && (
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 disabled:from-gray-400 disabled:to-gray-400 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg"
                  >
                    {isCapturing ? (
                      <>
